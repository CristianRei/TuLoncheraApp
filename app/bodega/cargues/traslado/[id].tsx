    ...
    <View style={styles.contenedor}>
      <View style={[styles.encabezado, { paddingTop: insets.top + 20 }]}>
        <ContenedorAncho anchoMaximo={640} style={styles.encabezadoContenido}>
          ...
          <Text style={styles.titulo}>
            {traslado ? `Traslado de ${traslado.promotorOrigenNombre} a ${traslado.promotorDestinoNombre}` : 'Traslado'}
          </Text>
        </ContenedorAncho>
      </View>
      ...
      {cargando ? (
        ...
        <ContenedorAncho anchoMaximo={640} llenarAlto>
          ...
          {lineas.length === 0 ? (
            <View style={styles.centrado}>
              <Text style={styles.vacio}>Este traslado no tiene productos.</Text>
            </View>
          ) : (
            <FlatList
              data={lineas}
